...
<body background="RegistrationPic.jpeg" style="background-size:cover;background-repeat:no-repeat;">
    <form onsubmit="event.preventDefault(); onFormSubmit();" autocomplete="off" >
	    ...
	    <label class="text-white travel">Travel Class</label>
           ...
           <pre> </pre>
            <input type="submit"  value="Add Passenger"  style="background-color:skyblue;"class="submit-btn ">
